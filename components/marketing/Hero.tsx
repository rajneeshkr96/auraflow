  ...
  return (
    <section className="relative pt-40 pb-20 px-6 overflow-hidden">
      ...
      <div className="absolute top-[15%] left-[8%] hidden lg:block pointer-events-none opacity-20">
        <svg width="140" height="140" viewBox="0 0 100 100" fill="none" className="text-indigo-600">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 border border-slate-200 text-slate-600 text-xs font-bold mb-8">
          <span className="flex h-2 w-2 rounded-full bg-pink-500 animate-pulse" />
          INSTAGRAM AUTOMATION FOR CREATORS
        </div>
        
        <h1 className="text-5xl md:text-8xl font-extrabold tracking-tight leading-[1.05] mb-8 text-slate-900">
        ...
        <div className="mt-8 flex items-center justify-center gap-2 text-slate-400 text-xs font-semibold">
